#Worst-Fit memory allocation algorithm using fixed partitioning
...
#for each process find the largest free block which has size greater than size of process
